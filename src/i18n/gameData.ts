...
export const especeSpecialTranslations: Record<string, string> = {
  ...
  "Endurance accrue": "Increased endurance",
  "Assommement": "Knockout",
  "Armure niv.1": "Armor lvl 1",
  "Armure niv.3": "Armor lvl 3",
  "Artilleur": "Gunner",
  "Brise-crâne": "Skull breaker",
  "Coupe jarret": "Hock blow",
  "Coupe-jarret": "Hock blow",
  "Duelliste": "Duelist",
  "Duelliste-patente": "Duelling licence",
  "Patente Duelliste": "Duelling licence",
  "Sauvage": "Savage",
  "Sauvage niv. 1": "Savage lvl 1",
  "Robustesse": "Toughness",
  "Toutes armes": "All weapons",
  "Toutes les Armes": "All weapons",
  ...
  "Crochetage niv.1": "Lockpicking lvl 1",
  "Glisseur": "Glider",
  "Pirate": "Pirate",
  "Natation": "Swimming",
  ...
  "Alphab. avancée": "Advanced literacy",
  "Alphabétisation avancée": "Advanced literacy",
  "Arcanique": "Arcane",
  "Astrologue": "Astrologer",
  "Clerc": "Cleric",
  "Détection Magie": "Magical Natural Detection",
  "Divination": "Divination",
  "Enchanteur": "Enchanter",
  "Illuminé": "Enlightened",
  "Lyrisme(4niv)": "Lyricism (4 lvl available)",
  "2e école(max2)": "2nd school (max 2)",
  "Magie création": "Magic at the creation",
  "Maldou": "Maldou",
  "Mystique": "Mystic",
  "Nécromancie": "Necromancy",
  "Necromancie": "Necromancy",
  "Tisseur": "Weaver",
  "Tisseur (Ténèbres +1)": "Weaver (Darkness +1)",
  "Tisseur (Ténèbres+1)": "Weaver (Darkness+1)",
  "Tisseur ou Clerc": "Weaver or Cleric",
  "Transcendance": "Transcendence",
  
  // Technologies et mécanisation
  "1 charbon": "1 coal card",
  "Émotions": "Emotions",
  "Mécanisation": "Mechanization",
  "PV→PA": "HP→AP",
  "évolution Êtres mécaniques": "Mechanical Beings evolution",
  "évolutions Êtres mécaniques": "Mechanical Beings evolutions",
  "Ecole de Magie du Mécanarcanum": "Magic school of Mecanarcanum",
  
  // Patentes et licences
  "Patente Entrepreneur": "Entrepreneur's licence",
  "Patente Marchand": "Merchant's licence",
  ...
  "Argousin": "Argousine",
  "Corsaire elfique": "Elven Corsair",
  "Marchands esclaves": "Slavers Merchants",
  "Marchand d'esclaves": "Slave trader",
  "Trafiquant cadavres": "Corpse dealer",
  "Trafiquant de cadavres": "Corpse dealer",
  
  // Titres/carrières
  "Titre/carrière: Capitaine de Navire-Volant": "Title/career: Airship Captain",
  "titre/carrière: Capitaine de navire": "Title/career: Ship Captain",
  "titre/carrière: Corsaire Elfique": "Title/career: Elven Corsair",
  "titre/carrière: Mercenaire Peau-Olive": "Title/career: Olive-Skinned Mercenary",
  "titre/carrière: Questeur de Parlos": "Title/career: Quaestor of Parlos",
  "titre/carrière: Greffier": "Title/career: Clerk",
  "titre/carrière: Capitaine de Navire": "Title/career: Ship captain",
  "titre/carrière: Capitaine de Navire-volant": "Title/career: Airship captain",
  "titre/carrière: Chef de bande organisée": "Title/career: Bandit leader",
  "titre/carrière: Ancien esclave": "Title/career: Former slave",
  "titre/carrière: Epervier": "Title/career: Sparrowhawk",
  "Templier": "Templar",
  ...
  "Grâce": "Grace",
  "Désincarnation accrue": "Increased disembodiment",
  "Résilience psychique": "Psychic resilience",
  "Stérile": "Sterile",
  
  // Immunités
  "Immunité aux poisons et toxines": "Poison immunity",
  "Immunité à l'assommement": "Knockout immunity",
  "Immunité aux maladies": "Disease immunity",
  "Immunité au sort frayeur": "Immunity to Fear spell",
  
  // Combinaisons complexes
  "Pêcheur, Acrobatie, Plongée sous-marine": "Fisherman, Acrobatics, Scuba diving",
  
  // Descriptions spéciales des espèces
