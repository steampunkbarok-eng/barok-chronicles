...
export const titresCarrieres: Titre[] = [
  ...
  { nom: "Greffier", cout: 2, incompatible: "Capitaine Navire/Navire-Volant, Chef de Bande Organisée, LAM, Mercenaire Peau-olive, Pirates, Planaires, Prévôt du Crépuscule, Sergent de l'ombre, Milicien, Enquêteur", prerequis: "Alphab. avancée + Solde" },
  ...
  { nom: "Porteur de Rune", cout: 2, incompatible: "Capitaine Navire/Navire-Volant, Ordre Chevaliers Suie (LAM), Planaire, Pirate, Mercenaire Peau-olive, Agent d'une ONG", prerequis: "Nains/Gnomes/Sautaises + Forgeron" },
