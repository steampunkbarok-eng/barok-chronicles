...
<body>
  ...
  <div class="page">
    ...
    <div style="border: 1px solid #000; padding: 0.3cm; margin: 0.3cm 0; page-break-inside: avoid;">
      ...
      ${character.marqueCollective ? `<div style="font-size: 8pt;">${language === 'en' ? 'Collective Mark' : language === 'nl' ? 'Collectief Merk' : 'Marque collective'} : ${character.marqueCollective}${character.marqueCollectiveDetail ? ` — <em>${character.marqueCollectiveDetail}</em>` : ''}</div>` : ''}
      ${character.marqueIndividuelle ? `<div style="font-size: 8pt; font-weight: bold;">${language === 'en' ? 'Individual Mark' : language === 'nl' ? 'Individueel Merk' : 'Marque individuelle'} : ${character.marqueIndividuelle}${character.marqueIndividuelleDetail ? ` — <em>${character.marqueIndividuelleDetail}</em>` : ''}</div>` : ''}
    </div>
    ` : ''}
  ...
  <div class="page">
    ...
    <table>
      ...
      <tr><td><strong>ABÎME X</strong></td><td>${t('announcements.abyss')}</td></tr>
      <tr><td><strong>ANIMATE DEAD</strong></td><td>${t('announcements.animateDead')}</td></tr>
      <tr><td><strong>BACK OFF</strong></td><td>${t('announcements.backOff')}</td></tr>
      <tr><td><strong>BLIND</strong></td><td>${t('announcements.blind')}</td></tr>
      <tr><td><strong>BONFIRE</strong></td><td>${t('announcements.bonfire')}</td></tr>
      <tr><td><strong>BURN</strong></td><td>${t('announcements.burn')}</td></tr>
      <tr><td><strong>CRUSH</strong></td><td>${t('announcements.crush')}</td></tr>
      <tr><td><strong>DEAD</strong></td><td>${t('announcements.dead')}</td></tr>
      <tr><td><strong>DISPEL MAGIC</strong></td><td>${t('announcements.dispelMagic')}</td></tr>
      <tr><td><strong>ENCHANTED</strong></td><td>${t('announcements.enchanted')}</td></tr>
      <tr><td><strong>GRACE</strong></td><td>${t('announcements.grace')}</td></tr>
      <tr><td><strong>HEAL</strong></td><td>${t('announcements.heal')}</td></tr>
      <tr><td><strong>HEADACHE</strong></td><td>${t('announcements.headache')}</td></tr>
      <tr><td><strong>HOLY</strong></td><td>${t('announcements.holy')}</td></tr>
      <tr><td><strong>ICE</strong></td><td>${t('announcements.ice')}</td></tr>
      <tr><td><strong>MERCURY</strong></td><td>${t('announcements.mercury')}</td></tr>
      <tr><td><strong>MUTE</strong></td><td>${t('announcements.mute')}</td></tr>
      <tr><td><strong>PAF</strong></td><td>${t('announcements.paf')}</td></tr>
      <tr><td><strong>RAISE DEAD</strong></td><td>${t('announcements.raiseDead')}</td></tr>
      <tr><td><strong>RESIST</strong></td><td>${t('announcements.resist')}</td></tr>
      <tr><td><strong>REVEAL</strong></td><td>${t('announcements.reveal')}</td></tr>
      <tr><td><strong>SILVER</strong></td><td>${t('announcements.silver')}</td></tr>
      <tr><td><strong>SHOCK</strong></td><td>${t('announcements.shock')}</td></tr>
      <tr><td><strong>SLEEP</strong></td><td>${t('announcements.sleep')}</td></tr>
      <tr><td><strong>STEP BACK</strong></td><td>${t('announcements.stepBack')}</td></tr>
      <tr><td><strong>STRIKE DOWN</strong></td><td>${t('announcements.strikeDown')}</td></tr>
      <tr><td><strong>THROUGH</strong></td><td>${t('announcements.through')}</td></tr>
      <tr><td><strong>TOXIC</strong></td><td>${t('announcements.toxic')}</td></tr>
    </table>
