    ...
    const adminHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9;">
        ...
        <div style="background-color: white; padding: 30px; border-radius: 0 0 8px 8px;">
          ...
          ${data.marqueCollective ? `<div style="margin: 20px 0;"><h3 style="color: #6B1836;">🔥 Marque collective</h3><p style="padding: 10px; background: #f0f0f0; border-radius: 4px;">${data.marqueCollective}${data.marqueCollectiveDetail ? `<br/><em>${data.marqueCollectiveDetail}</em>` : ''}</p></div>` : ''}
